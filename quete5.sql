...
-- 1️⃣ Afficher les trois véhicules les plus autonomes actuellement disponibles
...
-- 2️⃣ Afficher la ville possédant le plus de véhicules disponibles
...
-- 3️⃣ Afficher les clients ayant effectué au moins deux locations
SELECT id_client, COUNT(*) AS nb_locations
FROM location
GROUP BY id_client
HAVING COUNT(*) >= 2;

-- 4️⃣ Afficher les véhicules n’ayant jamais été loués
